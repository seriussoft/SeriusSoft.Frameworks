...
{
  public class TestBatchableViewModel : BatchableBaseViewModel, IBackedByModel
  {
    ...
    public TestBatchableViewModel() { }

    public TestBatchableViewModel(TestModel model)
    {
      this.Model = model;
    }
